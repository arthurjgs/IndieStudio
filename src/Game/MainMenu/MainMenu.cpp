...
Scene(manager)
{
    ...
    this->__objContainer.emplace_back(std::make_shared<Music>("MainMusic", Bomberman::Config::ExecutablePath + "assets/sounds/hero_ost.mp3", this->__config.getValue(UserConfig::ValueType::MUSIC_VOL)));
